...
<!-- Validate Session -->
@if (session('success'))
    <div class="w-full bg-indigo-800 text-white p-4 rounded-md mb-2">
        {{ session('success') }}
    </div>
@endif
            ...
            @forelse($jobApplications as $jobApplication)
                <div class="bg-gray-900 p-4 rounded-lg">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <a href="{{ Storage::disk('cloud')->url($jobApplication->resume->fileUrl) }}" target="_blank" class="text-indigo-500 hover:text-indigo-600">View Resume</a>
                    </div>
                    ...
                    <div class="flex flex-start flex-col gap-2 mt-4">
                        <div class="flex items-center gap-2">
                            ...
                            <p class="text-sm bg-indigo-600 text-white p-2 rounded-md w-fit">Score: {{ $jobApplication->aiGeneratedScore }}</p>
                        </div>
