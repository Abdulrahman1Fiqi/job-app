<x-main-layout title="HireHub - Find your dream job">
    ...
    <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 300)">
        <div
            ...
            <a href="{{ route('register') }}" class="rounded-lg bg-white/10 px-4 py-2 text-white">
                Create an Account 
            </a>           
            <a href="{{ route('login') }}" class="rounded-lg bg-gradient-to-r from-indigo-500 to-rose-500 px-4 py-2 text-white">
                Login
            </a>           
